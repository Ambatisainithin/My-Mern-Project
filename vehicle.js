...
app.get('/bookingtoadmin', verifyToken, authorizeRoles('admin'), bookingtoadmin)

app.patch("/bookings/:id/status", verifyToken, authorizeRoles('admin'), updateBookingStatus);
